...
export function DocumentHeader({ agreement }: { agreement: Agreement }) {
  // ...
  agreement.songTitle  // ✅ This property exists now
  agreement.id         // ✅ This property exists now
};
...
// ===== AGREEMENT =====
export type AgreementStatus = 'draft' | 'pending' | 'signed' | 'archived' | 'Completado' | 'Borrador' | 'Pendiente';

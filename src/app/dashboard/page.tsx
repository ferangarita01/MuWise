...
import { PlusCircle, FileText, Send, CheckCircle, Clock, Edit, VenetianMask, Download } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
function AgreementActions({ agreementId }: { agreementId: string }) {

          ...
          <div className="rounded-xl border bg-secondary shadow-sm ring-1 ring-white/5">
              <div className="overflow-hidden rounded-t-xl">
                  <div className="relative">
                      <img src="https://images.unsplash.com/photo-1670852714979-f73d21652a83?w=2560&q=80" data-ai-hint="mountains landscape" alt="Mountains header" className="h-40 w-full object-cover sm:h-44 md:h-48" />

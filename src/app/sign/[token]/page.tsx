...
function SignPageComponent() {
  ...
  const handleApplySignature = async () => {
    ...
    if (result.status === 'success') {
      toast({ title: '¡Éxito!', description: 'El documento ha sido firmado correctamente. Puede cerrar esta ventana.' });
      // In a real scenario, you might redirect to a generic "thank you" page
      // For now, we disable the button and show a success state.
      setStatus('loading'); // Show a loading/completed state
      setError("Firma completada. ¡Gracias!");
        ...
        return (
          <>
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold mb-2">Solicitud de Firma de Invitado</h2>
              <p className="text-slate-300 mb-6">Estás a punto de firmar un documento como invitado.</p>
            </div>
            ...
            >
              {isSigning ? (
                ...
                <><CheckCircle className="mr-2 h-4 w-4" /> Firmar y Aceptar como Invitado</>
              )}
            </Button>

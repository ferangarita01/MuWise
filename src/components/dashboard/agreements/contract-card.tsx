...
export function ContractCard({ contract, onQuickView }: ContractCardProps) {
    ...
    return (
        <article id={contract.id} className="contract-card group relative rounded-xl overflow-hidden border border-white/10 bg-gradient-to-b from-white/5 to-transparent hover:border-white/20 transition">
            ...
            <div className="p-4">
                ...
                <div className="mt-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={handleDownload} className="download-btn px-3 h-9 rounded-md bg-white/5 border border-white/10 text-sm text-slate-300 hover:text-white hover:border-white/20 transition flex items-center gap-2">

...
import { ShieldCheck, MailCheck, Smartphone, Laptop, LogOut, Trash2 } from 'lucide-react';
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative flex-grow">
                            ...
                            <Input id="email" type="email" value="alina.vera@muwise.com" readOnly className="pl-10" />
                        </div>
